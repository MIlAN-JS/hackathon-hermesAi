  ...
  const features = [
    {
      ...
      desc: "Consolidate tools, reduce spend, and gain unified reporting without painful integrations.",
    ...
    {
      title: "Get more done, more easily.",
    ...
    {
      title: "Bill on time, every time.",
      desc: "AI-driven billing engine and expert services run in the background so you collect more, faster.",
